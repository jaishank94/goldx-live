...
const Footer = () => {
  ...
  return (
    <Fragment>
      <footer className="text-center relative bottom-0 w-full pt-48 mt-48 bg-white dark:bg-neutral-800">
        <div className="max-w-7xl mx-2 absolute -top-36 left-0 right-0 rounded-3xl lg:mx-auto bg-[url('/images/footer-image.jpg')] bg-cover object-fill p-10">
          <div className="flex justify-between">
            <div className="md:w-1/2 text-left">
              ...
              <button className="rounded-full cursor-pointer pb-[1.8px] mx-auto pb-[0.8px] text-xl bg-gradient-to-r from-gold-200 to-gold-100 ">
      ...
      <div className="w-full py-2 bg-black items-center bg-[#EDF1F4] dark:bg-neutral-900 ">
        <div className="cursor-pointer text-sm text-gray-500 text-center uppercase">
          © {new Date().getFullYear()} Gold.Live. All Rights Reserved
        </div>
      </div>
