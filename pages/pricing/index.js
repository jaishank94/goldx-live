        ...
        <div className="max-w-screen-xl mx-2 md:mx-auto">
          ...
          <div className="flex flex-col items-center justify-center p-10">
            <div className="flex flex-wrap items-center justify-center w-full max-w-6xl">
              <div className="flex flex-col flex-grow mt-8 md:w-1/3 overflow-hidden bg-[#f4eddfd1] dark:bg-neutral-900 border border-gold-100/60 shadow-lg">
                <div className="text-center p-6">
                  <span className="text-lg font-semibold">Basic<span className='font-normal text-sm dark:text-gold-200/50'>/for personal use</span></span>
                </div>
                <div className="p-4 text-center dark:from-neutral-800 dark:to-neutral-800 bg-gradient-to-r from-gold-200/30 to-gold-100/20">
                ...
                <div className="p-10 leading-8">
                  <ul>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">11 market data endpoints</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">10k call credits/mo</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">No historical</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">Personal use</span>
                    </li>
                  </ul>
                </div>
              ...
              {/* Tile 2 */}
              <div className="z-10 flex flex-col flex-grow mt-8 md:w-1/3 overflow-hidden transform dark:from-neutral-800 dark:to-neutral-800 bg-gradient-to-b from-[#e7dcc3] to-[#f4eddfd1] dark:bg-neutral-900 border border-gold-100/60 shadow-lg md:scale-110">
                <div className="text-center p-6">
                  <span className="text-lg font-semibold">Startup<span className='font-normal text-sm dark:text-gold-200/50'>/for commercial use</span></span>
                </div>
                <div className="p-4 text-center bg-gradient-to-r from-gold-300 to-gold-100">
                ...
                <div className="p-10 leading-8">
                  <ul>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">21 market data endpoints</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">120k call credits/mo</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">1 month history.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2 font-medium">Commercial use*</span>
                    </li>
                  </ul>
                </div>
                <div className='mb-10'>
                  <div className='p-[2px] rounded-full overflow-hidden w-1/2 mx-auto bg-gradient-to-r from-[#a8773f] to-gold-100/50'>
                    <div className="bg-[#f6f0e5] dark:bg-neutral-800 rounded-full text-center">
              ...
              <div className="flex flex-col flex-grow overflow-hidden md:w-1/3 bg-[#f4eddfd1] dark:bg-neutral-900 border border-gold-100/60 shadow-lg mt-8">
                <div className="text-center p-6">
                  <span className="text-lg font-semibold">Standard<span className='font-normal text-sm dark:text-gold-200/50'>/suitable</span></span>
                </div>
                <div className="p-4 text-center dark:from-neutral-800 dark:to-neutral-800 bg-gradient-to-r from-gold-200/30 to-gold-100/20">
                ...
                <div className="p-10 leading-8">
                  <ul>
                    <li className="flex items-center">
                      ...
                      <span className="ml-2">29 market data endpoints</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">500k call credits/mo</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span className="ml-2">3 month of historical data</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-5 h-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
